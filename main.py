...
from ift6758.visualizations.simple_visualizations import shots_efficiency_by_type, shots_efficiency_by_distance, shots_efficiency_by_type_and_distance
...
if __name__ == "__main__":
    ...
    if not os.path.exists(path) :
        ...
        all_plays_df = extract_and_cleanup_play_data(start_date, end_date,
                                                     columns_to_keep = ['gameId', 'season', 'gameType', 'dateTime', 'team', 'event',
