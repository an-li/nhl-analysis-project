...
def roc_auc_curve(y_val : np.array, models : dict, model_name : str, save: bool = True, plot: bool = True, path_to_save: str = "./") :
    '''
    plot ROC/AUC 
...
def goal_rate_curve(y_val : np.array, models : dict, model_name : str, save: bool = True, plot: bool = True, path_to_save: str = "./") :
    '''
    plot goal rate
...
def goal_rate_cumulative_curve(y_val : np.array, models : dict, model_name : str, save: bool = True, plot: bool = True, path_to_save: str = "./") :
    '''
...
def calibration(y_val : np.array, models : dict, model_name : str, save: bool = True, plot: bool = True, path_to_save: str = "./") :
    '''
    plot calibration
