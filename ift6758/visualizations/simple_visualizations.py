...
def shots_efficiency_by_distance(plays_df: pd.DataFrame, seasons_list : list, save : bool = True, plot : bool = True, path_to_save : str = "./", group_feet : int = 6) -> tuple :
    """
    ...
    for season in seasons_list :
        ...
        df["distanceToGoal"] = (df["distanceToGoal"].astype("int64")).apply(lambda x : group_feet * ((x-1) // group_feet) + 1) # Regroup shot by 10 feet distances
...
def shots_efficiency_by_type_and_distance(plays_df: pd.DataFrame, season : int, save : bool = True, plot : bool = True, path_to_save : str = "./", group_feet : int = 6) -> tuple :
    '''
